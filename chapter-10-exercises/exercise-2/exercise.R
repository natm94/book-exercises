...
employee <- employees
salaries <- data.frame(employee, salaries_2017, salary_adjustments)
...
salaries[salaries$employee == "employee 57", "salary_2018"]
...
salaries[salaries$salary_adjustments == biggest_paycut, "employee"]
